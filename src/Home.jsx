    ...
    <img key={repeatIdx + '-' + idx} src={`/college image/${img}`} alt={img.replace('.webp', '').replace('.jpeg', '')} className="college-marquee-img" />
      ...
      <section className="testimonial-section">
        <div className="testimonial-content">
          <h2>Testimonial</h2>
          <h3>What alumni say about us</h3>
          <div className="testimonial-list">
            <div className="testimonial-card">
              <div className="testimonial-title">"Best Investment in My Career!"</div>
              <div className="testimonial-review">Review: Choosing Mavenly was the best decision I made for my career. The hands-on projects boosted my confidence, and the certifications helped me land multiple job offers. Worth every penny!</div>
              <div className="testimonial-name">Emily Rodriguez</div>
              <div className="testimonial-location">Maluku</div>
            </div>
            <div className="testimonial-card">
              <div className="testimonial-title">ByteSkill has been a game-changer for me.</div>
              <div className="testimonial-review">The course selection is fantastic, and the self-paced learning allowed me to balance my studies with work. I gained valuable skills, and now I'm thriving in my new IT job. Thank you, mavenly!</div>
              <div className="testimonial-name">Sarah Williams</div>
              <div className="testimonial-location">Jakarta</div>
            </div>
            <div className="testimonial-card">
              <div className="testimonial-title">Top-Notch Instructors and Supportive Community</div>
              <div className="testimonial-review">Review: Mavenly's instructors are exceptional, making complex topics easy to understand. The discussion forum helped me connect with fellow learners, and the support team was always responsive. Highly recommended!</div>
              <div className="testimonial-name">John Smith</div>
              <div className="testimonial-location">Bandung</div>
            </div>
            <div className="testimonial-card">
              <div className="testimonial-title">"Best Investment in My Career!"</div>
              <div className="testimonial-review">Review: Choosing Mavenly was the best decision I made for my career. The hands-on projects boosted my confidence, and the certifications helped me land multiple job offers. Worth every penny!</div>
