        ...
        <section className="footer-contact-section">
          ...
          <div className="footer-contact-center">
            <div className="footer-contact-center-col">
              ...
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/programs')}>E-Learning</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/programs')}>Bootcamp</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/programs')}>Webinar</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/programs')}>Certifications</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/testimonial')}>Mentoring</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/contact')}>Corporate Services</div>
            </div>
            <div className="footer-contact-center-col">
              <div className="footer-contact-center-col-title">Company</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/about')}>About us</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/testimonial')}>Leadership</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/placement')}>Careers</div>
              <div className="footer-contact-center-col-item" style={{cursor:'pointer'}} onClick={() => navigate('/testimonial')}>Testimonials</div>
